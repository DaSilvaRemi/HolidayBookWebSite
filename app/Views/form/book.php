...
<body>
    ...
    <select name="typelogement">
        ...
        <?php 
        $tabTypeLogemet = \App\Controllers\BookForm::showData();
        foreach ($tabTypeLogemet as $typelogement) {
            echo '<option value="'.$typelogement['typelogement'].'">'.$typelogement['typelogement'].'</option>';
 } ?>    
    </select>
